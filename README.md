...
- ELB / EVS / NAT / RDS：已登记常用 list 查询、第一层 show/detail 查询和通用 guarded change flow；本地缺少 operation detail 时通过显式参数白名单保守执行
...
│   ├── hcloud_guarded_change_flow.py  # 多服务通用变更确认门禁
